...
public class US_020_User_Management_StepDefs {
    ...
    public void admin20_signs_in() {
       loginPage.LoginAdam.click();
        loginPage.signIn.click();
        loginPage.usernameBox.sendKeys("AdminMurat44");
...
loginPage.ItemLogin1.click();

    }
    @Given("user enters a valid SSN number as {string}")
    public void user_enters_a_valid_ssn_number_as(String string) {


    }
    @Given("user enters a valid first name as {string}")
    public void user_enters_a_valid_first_name_as(String string) {

    }
    @Given("user enters a valid last name as {string}")
    public void user_enters_a_valid_last_name_as(String string) {

    }
    @Given("user enters an username as {string}")
    public void user_enters_an_username_as(String string) {

    }
    @Given("user enters a valid email address as {string}")
    public void user_enters_a_valid_email_address_as(String string) {

    }
    @Given("user enters a new password as {string} and confirm password as {string}")
    public void user_enters_a_new_password_as_and_confirm_password_as(String string, String string2) {
