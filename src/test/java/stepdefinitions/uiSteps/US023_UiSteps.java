...
public class US023_UiSteps {

    US23_Page staff = new US23_Page();
    ...
    public void kullanici_account_menu_iconuna_tiklar() {
        // Write code here that turns the phrase above into concrete actions
    ...
    public void kullanici_username_kismina_valid_staff_deger_girer() {
        staff.UsernameTextbox.sendKeys("staff.murattm");
    }
