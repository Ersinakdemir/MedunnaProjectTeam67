...
//                System.out.println(i++);
    ...
    public static List<Object> returnAppointmentStartDateList(String filePath) {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(filePath))) {
            ...
            while (line != null) {
                Appointments appointments = new Appointments();
                appointments.setStartDate(line.split(",")[0]);
                sb.append(System.lineSeparator());
                line = br.readLine();

//                System.out.println(i++);

                all.add(appointments.getStartDate());
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static List<Object> returnAppointmentEndDateList(String filePath) {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(filePath))) {
            ...
            while (line != null) {
                Appointments appointments = new Appointments();
                appointments.setEndDate(line.split(",")[0]);
                sb.append(System.lineSeparator());
                line = br.readLine();

//                System.out.println(i++);

                all.add(appointments.getEndDate());
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static List<Object> returnAppointmentStatusList(String filePath){
        ...
        try(BufferedReader br = new BufferedReader(new FileReader(filePath))) {
            ...
            while (line != null) {
                Appointments appointments = new Appointments();
                appointments.setStatus(line.split(",")[0]);
                sb.append(System.lineSeparator());
                line = br.readLine();

//                System.out.println(i++);

                all.add(appointments.getStatus());
            }
        }catch (Exception e){
            e.printStackTrace();
        }
